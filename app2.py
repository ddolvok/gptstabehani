...
def generate_response(user_input):
    ...
    system_role = "System: I'd like to create an image of the styles of famous landscape painters. there are painters like that  'Alejandro Bursido', 'Jacques-Laurent Agasse', 'Andreas Achenbach', 'Cuno Amiet' etc. Create an image by randomly selecting one of the famous painters.. Make a sentence around 150 characters. please answer in English!"
